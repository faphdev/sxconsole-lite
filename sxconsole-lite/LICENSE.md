...
6.  Versions of the License.
    ...
    6.1 New Versions.
    Skylable Ltd ("Skylable") may publish revised and/or new versions of the License from
    ...
    Skylable. No one other than Skylable has the right to modify the terms applicable to
    ...
    rename Your license so that the phrases "Skylable", "CPAL" or any confusingly similar
...
EXHIBIT A. Common Public Attribution License Version 1.0.
    ...
    {LICENSE_URL}. The License is based on the Mozilla
    ...
    The Original Code is the sxconsole-lite project.
...
EXHIBIT B. Attribution Information
    ...
    Attribution Copyright Notice: Copyright (C) 2015-2016 info-copyright@skylable.com
    Attribution Phrase: Check out what else SX Enterprise has to offer!
    Attribution URL: http://www.skylable.com/products/enterprise/

    This display should be, at a minimum, the Attribution Phrase linked to the
    Attribution URL.
