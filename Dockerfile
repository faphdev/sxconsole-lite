...
RUN yum -y install nginx supervisor python-pip nodejs npm pwgen python-devel py-bcrypt git gettext
...
COPY sxconsole-lite/requirements.txt sxconsole-lite/package.json sxconsole-lite/i18n-manager.js /srv/sxconsole-lite/
